      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          double targetSpeed = 100 -(fabs(angle)*10);

          double speed_cte = targetSpeed - speed;
          ...
          // DEBUG
          if(!TWIDDLE) {
            std::cout << "CTE: " << cte << " Steering Value: " << steer_value << " Angle: " << angle << " Speed: "
                      << speed <<  std::endl;
          }

          if(TWIDDLE && fabs(cte)>5){
